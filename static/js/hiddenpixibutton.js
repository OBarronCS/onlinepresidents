...
// button with no sprite -> can be tinted though
export default class HiddenPixiButton {

    constructor(x, y, width, height, text, value, callback){
        this.x = x
        this.y = y

        this.sprite = new Sprite(PIXI.Texture.WHITE);

        this.sprite.basealpha = 0
        this.sprite.hoveralpha = .3

        this.sprite.basecolor = 0xffffff
        this.sprite.hovercolor = 0xfffcad

        this.sprite.alpha = this.sprite.basealpha
        ...
        this.sprite
                ...
                function updateColor(thing){
                    if(!thing.isOver){
                        ...
                        thing.alpha = thing.basealpha
                    } else if(thing.isOver){
                        thing.tint = thing.hovercolor 
                        thing.alpha = thing.hoveralpha
                    }
                }
    ...
    drawOutline(){
        this.outline.lineStyle(4,0x53eb34)
        this.outline.drawRect(1 + this.sprite.x - this.sprite.width / 2,this.sprite.y - this.sprite.height / 2,this.sprite.width,this.sprite.height)
    }
